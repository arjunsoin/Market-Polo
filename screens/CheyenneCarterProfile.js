  ...
  render() {
    ...
    return (
      <ScrollView style={styles.container}>
        ...
        <Text style= {{fontSize: 32, fontWeight: 'bold', color: '#96594A', paddingTop: 5, margin: 12}}> Cheyenne Carter </Text>        
        </View>
        ...
        <View style={styles.profilePic}>
          ...
          <Image 
            ...
            source={require('../assets/images/CheyenneCarter.jpg')}
          />
        </View>
        ...
        <View style={{flexDirection: 'row', marginBottom: 10, flexDirection: 'row', justifyContent: 'space-between'}}>
          ...
          <View style={styles.barterButton}>    
            <TouchableOpacity
              onPress={
                () => navigate('Barter',{
                  farmerName: 'Farmer Cheyenne',
                  imageName: farmerData[1].image,
